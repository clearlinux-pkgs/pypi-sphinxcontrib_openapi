...
Version  : 0.8.0
Release  : 11
URL      : https://files.pythonhosted.org/packages/62/f0/18c0ffba458bd8a0db08e9d60e59b186f959a1814bacdbe2a7621ca7b987/sphinxcontrib-openapi-0.8.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/62/f0/18c0ffba458bd8a0db08e9d60e59b186f959a1814bacdbe2a7621ca7b987/sphinxcontrib-openapi-0.8.0.tar.gz
...
%prep
%setup -q -n sphinxcontrib-openapi-0.8.0
cd %{_builddir}/sphinxcontrib-openapi-0.8.0
pushd ..
cp -a sphinxcontrib-openapi-0.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673917465
